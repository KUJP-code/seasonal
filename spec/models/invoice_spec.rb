...
RSpec.describe Invoice do
  ...
  context 'when automatic adjustments apply' do
    ...
    context 'when considering repeater discount' do
      it 'applies if external kid not attending first seasonal and > 9 activity regs' do
      end
      ...
      it 'does not apply if < 9 activity regs' do
      end
